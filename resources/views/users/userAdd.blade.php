                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="student_name" placeholder="Student Name" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="student_surname" placeholder="Student Surname" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="student_email" placeholder="Student Email" class="form-control">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="student_phone" placeholder="Student Phone" class="form-control">
